...
#include "mystring.h"
/*
	Things to change in mystring.cpp:
	1. cin and/or getline functions
	2. the int mystring constructor
	3. when adding letters outside scope, should change the scope to add them
